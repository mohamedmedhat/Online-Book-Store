...
namespace Online_Book_Store.Controllers
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(Online_Book_StoreContext context)
        {
            _context = context;
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=DESKTOP-94CVM89;Initial Catalog=BookStore;Integrated Security=True;Connect Timeout=30");
            string sql;
